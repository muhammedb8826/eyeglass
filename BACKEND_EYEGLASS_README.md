...
- **OrderItem** – a single lens job line (usually a pair of lenses).
...
All of these are **optional** in the API; required fields are enforced by the frontend or by separate validation rules.
...
- **Backend**
  - Is the **source of truth**:
    ...
    - Queries `lab-tools` (or uses `/lab-tools/check`) to validate producibility.
