...
import { useCreateMachineMutation } from "@/redux/machines/machinesApiSlice";
...
type MachineRegistrationProps = {
  handleModalOpen: (value: boolean) => void;
};

export const MachineRegistration = ({ handleModalOpen }: MachineRegistrationProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (fetchError.status === 409) {
        ...
        toast.error("Machine creation failed");
      }
    }
  };
  return (
