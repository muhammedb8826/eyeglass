import { useCreateServiceMutation } from "@/redux/services/servicesApiSlice";
...
type ServiceRegistrationProps = {
  handleModalOpen: (value: boolean) => void;
};

export const ServiceRegistration = ({ handleModalOpen }: ServiceRegistrationProps) => {
