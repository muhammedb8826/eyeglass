...
import { useGetVendorQuery, useUpdateVendorMutation } from "@/redux/vendor/vendorApiSlice";
...
export const VendorEdit = ({ handleModalOpen, id }: { handleModalOpen: (isOpen: boolean) => void; id: string }) => {
  const { data, isLoading, error, isError, refetch } = useGetVendorQuery(id);
