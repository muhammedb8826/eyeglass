  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full overflow-hidden flex-shrink-0">
          <img
            src={getProfileImageUrl(user?.profile) || UserOne}
            alt={user?.first_name ? `${user.first_name} profile` : 'User'}
