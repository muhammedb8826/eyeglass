...
import { useCreateCustomerMutation } from "@/redux/customer/customerApiSlice";
...
export const CustomerRegistration = ({ handleModalOpen }: CustomerRegistrationProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = handleApiError(fetchError, "Customer creation failed");
