...
import { useGetDiscountQuery, useUpdateDiscountMutation } from "@/redux/discount/discountApiSlice";

interface ErrorData {
  message: string;
}

export default function DiscountEditModal({ handleModalOpen, id }: { handleModalOpen: (isOpen: boolean) => void; id: string }) {
  const { data, isLoading, error, isError, refetch } = useGetDiscountQuery(id);
...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await updateDiscount(data).unwrap();
