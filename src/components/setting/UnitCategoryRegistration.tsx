...
import { useCreateUnitMutation } from "@/redux/unit/unitApiSlice";
...
const UnitCategoryRegistration = ({ handleModalOpen }: UnitRegistrationProps) => {
...
export default UnitCategoryRegistration;
