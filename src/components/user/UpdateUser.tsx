...
const UpdateUser = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      setSelectedFile(user.profile ? `/uploads/profile/${user.profile}` : null);
    }
  }, [user, id]);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("roles", selectedRoles.toUpperCase());
    formData.append("is_active", userData.isActive ? "true" : "false");
    if (profileImage) {
  ...
  return isFetching || isUpdating ? (<Loader />) : (
    <>
          ...
          <div className="col-span-5 xl:col-span-3">
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                ...
                <div className="mb-5.5 py-3 px-4.5 flex flex-col gap-5.5 sm:flex-row rounded border border-stroke text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary">
                  <div className="w-full sm:w-1/2">
                    <input
                      ...
                      value="MALE"
                      name="gender"
                      className="w-4 h-4 rounded border border-stroke py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      onChange={(e) =>
                ...
                <div className="flex flex-col gap-5.5">
                  <SelectRoles selectedRoles={selectedRoles} onRolesChange={handleRolesChange} />
                </div>
              </div>
            </div>
          </div>
